...
public class CustomerServiceImpl extends ServiceImpl<CustomerMapper, Customer> implements ICustomerService {
    ...
    public void saveCustomer(Customer customer) {
        ...
        AssertUtil.isTrue(null !=this.findCustomerrByName(customer.getName()),"客户已存在!");
        customer.setIsDel(0);
    ...
    public void updateCustomer(Customer customer) {
        ...
        checkParams(customer.getName(),customer.getContact(),customer.getNumber());
        Customer temp = this.findCustomerrByName(customer.getName());
    ...
    @Override
    public Customer findCustomerrByName(String name) {
